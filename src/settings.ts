...
export class SettingsTab extends PluginSettingTab {
  ...
  constructor(app: App, plugin: ActionsPlugin) {
    super(app, plugin);
    this.plugin = plugin;
  }
      ...
      new Setting(host)
        ...
        .addExtraButton(btn => {
          btn
            ...
            .onClick(() => {
              const onSubmit = (result: Action) => {
                console.debug(`updated action ${result.id}.`);
      ...
      btn
        ...
        .onClick(() => {
          const onSubmit = (action: Action) => {
            console.debug(`created new command ${action.id}.`);
...
export class CreateEditActionModal extends Modal {
  ...
  private readonly onSubmit: (_: Command) => void;

  constructor(app: App, plugin: ActionsPlugin, onSubmit: (_: Command) => void, payload?: Action) {
    super(app);
    ...
    new Setting(container)
      ...
      .addText(text => {
        text
          ...
          .setPlaceholder('lucide-sparkles')
          .onChange(value => {
